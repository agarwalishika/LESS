...
CUDA_VISIBLE_DEVICES=0 python3 -m less.data_selection.write_selected_data \
...
./less/scripts/train/warmup_lora_train.sh "$DATA_DIR" "$MODEL_PATH" "$PERCENTAGE" "$DATA_SEED" "$JOB_NAME" "$LENGTH"
